...
import type { Announcement, CalendarEntry, FollowUp, FollowUpActivity, TickerItem, TrainingsResponse } from "./types";
...
type SharedName = "entries" | "followUps" | "removedTriggers" | "announcements";
type SharedDoc = { id: string } & Record<string, unknown>;
const SHARED: SharedName[] = ["entries", "followUps", "removedTriggers", "announcements"];
...
export function StoreProvider({ children }: { children: React.ReactNode }) {
  ...
  const synced = useRef<Record<SharedName, Map<string, string>>>({
    entries: new Map(), followUps: new Map(), removedTriggers: new Map(), announcements: new Map(),
  });
